...
Checkmate.prototype.canPieceMoveToSquare = function canPieceAttackSquare(move) {
  return move.square.piece.isValidMove(move) && move.isValid()
}
...
Checkmate.prototype.canPieceBeAttacked = function canPieceBeAttacked(square) {
  for (var i=0; i < this.squares.length; i++) {
    ...
    if (this.canPieceMoveToSquare(potentialMove)) return true;
  };
  return false
}
